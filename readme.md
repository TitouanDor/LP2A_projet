...
to use it you need first to have the right to execute the file and then in the root directory of the project do ```./compile.bash``` to compile and run the project
